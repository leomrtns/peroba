...
def read_fasta_original (filename, zip = "bz2", fragment_size = 0, check_name = False, debug = False):
    # This version has the "zip" parameter, but currently I am assuming the suffix has it
    unaligned = []
    if (zip == "bz2"):
        this_open = bz2.open
    elif (zip == "gz"):
